		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-7 col-md-6 justify-content-center ">
					<h6 class="text-uppercase">Leave other necessities, home is everything</h6>
					<h1>
						All things need to construct
					</h1>
					<p class="text-white">
						Menjadi apapun untuk mewujudkan bangunan impian anda. Dengan kami kami menjadi partner anda, impian anda menjadi semakin dekat.
					</p>
					<a href="<?= site_url('Contact') ?>" class="primary-btn header-btn text-uppercase mt-10">Get Started</a>
				</div>
				<div class="banner-img col-lg-5 col-md-6 align-self-end">
					<img class="img-fluid" src="asset_compro/img/banner-img.png" alt="">
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-12 pb-50 header-text text-center">
					...
					<p>
						Kami mengerti kebutuhan anda dalam membangun..
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-service">
						<div class="thumb">
							<img src="asset_compro/img/jasa/consultation.jpg" alt="" height="175" width="42">
						</div>
						<h4>Konsultasi</h4>
						<p>
							Konsultasi aja kesini, yang awalnya mimpi anda terasa jauh dengan berkonsultasi pasti impian anda akan terasa sangat dekat, kare kami memberikan yang terbaik.
						</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="single-service">
						<div class="thumb">
							<img src="asset_compro/img/jasa/architect.jpg" alt="" height="175" width="42">
						</div>
						<h4>Desain Arsitek</h4>
						<p>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-service">
						<div class="thumb">
							<img src="asset_compro/img/jasa/rab.jpg" alt="" height="175" width="42">
						</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="single-service">
						<div class="thumb">
							<img src="asset_compro/img/jasa/build.jpg" alt="" height="175" width="42">
						</div>
						<h4>Pembangunan dan renovasi</h4>
						<p>
							inappropriate behavior is oftenlaug hed off as “boys will be boys,” women face higher conduct women face higher conduct.
						</p>
					</div>
		...
		<div class="container">
			...
			<div class="total-work-process d-flex flex-wrap justify-content-around align-items-center">
				...
				<div class="work-arrow">
					<img src="asset_compro/img/arrow.png" alt="">
				</div>
				<div class="single-work-process">
					<div class="work-icon-box">
			...
			<div class="row">
				<div class="active-testimonial-carusel">
					<div class="single-testimonial item">
						<img class="mx-auto" src="asset_compro/img/t1.png" alt="">
						<p class="desc">
					...
					<div class="single-testimonial item">
						<img class="mx-auto" src="asset_compro/img/t2.png" alt="">
						<p class="desc">
							Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
						</p>
						<h5>Mark Alviro Wiens</h5>
					...
					<div class="single-testimonial item">
						<img class="mx-auto" src="asset_compro/img/t3.png" alt="">
						<p class="desc">
							Accessories Here you can find the best computer accessory for your laptop, monitor, printer, scanner, speaker, projector, hardware and more. laptop accessory
						</p>
						<h5>Mark Alviro Wiens</h5>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="asset_compro/img/b1.jpg" alt="">
					</div>
				...
				<div class="col-lg-3 col-md-6 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="asset_compro/img/b2.jpg" alt="">
					</div>
					<p class="meta">25 October, 2017 | By <a href="#">Mark Wiens</a></p>
					<a href="blog-single.html">
				...
				<div class="col-lg-3 col-md-6 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="asset_compro/img/b3.jpg" alt="">
					</div>
					<p class="meta">25 October, 2017 | By <a href="#">Mark Wiens</a></p>
					<a href="blog-single.html">
				...
				<div class="col-lg-3 col-md-6 single-blog">
					<div class="thumb">
						<img class="img-fluid" src="asset_compro/img/b4.jpg" alt="">
					</div>
					<p class="meta">25 October, 2017 | By <a href="#">Mark Wiens</a></p>
					<a href="blog-single.html">
			...
			<div class="brand-wrap">
				<div class="row align-items-center active-brand-carusel justify-content-start no-gutters">
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="asset_compro/img/l1.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="asset_compro/img/l2.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="asset_compro/img/l3.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="asset_compro/img/l4.png" alt=""></a>
					</div>
					<div class="col single-brand">
						<a href="#"><img class="mx-auto" src="asset_compro/img/l5.png" alt=""></a>
					</div>
				</div>
			</div>
		</div>
